...
@interface OtherProfileController (){
    UIImageView *imggeter,*comment;
    UIView *mainView,*imageview,*headerView,*cell_View;
    ...
    UITableView *jobtableView,*boardtableView,*podcasttableView;
}

@end

@implementation OtherProfileController

- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    [self.view setBackgroundColor:[UIColor colorWithRed:244.0f/255.0f green:244.0f/255.0f blue:255.0f/255.0f alpha:1.0f]];
}

- (void)viewDidAppear:(BOOL)animated{
    [self creteScreen:_profileAr :_friendId.intValue];
}
...
- (void)creteScreen:(NSArray *) profileAr:(int)frnid{
    
    UIView *topView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 22)];
    [topView setBackgroundColor:[UIColor colorWithRed:244.0f/255.0f green:244.0f/255.0f blue:255.0f/255.0f alpha:1.0f]];
    [self.view addSubview:topView];
    headerView=[[UIView alloc] initWithFrame:CGRectMake(0, 22, self.view.frame.size.width, 70)];
    headerView.backgroundColor=[UIColor colorWithRed:244.0f/255.0f green:244.0f/255.0f blue:255.0f/255.0f alpha:1.0f];
    
    UIView *topViewSep = [[UIView alloc] initWithFrame:CGRectMake(0, 46, self.view.frame.size.width, 1)];
    [topViewSep setBackgroundColor:[UIColor colorWithRed:0.53 green:0.60 blue:0.94 alpha:1.0]];
    [headerView addSubview:topViewSep];
    ...
    UITapGestureRecognizer *astreg = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(GoBack)];
    ...
    mainView= [[UIView alloc] initWithFrame:CGRectMake(0,70,[SavePrefrences sharedInstance].screenWidth,[SavePrefrences sharedInstance].screenHeight-70)];
...
-(void) addButtons
{
    ...
    for(int x=0;x<[btnAr count];x++)
    {
        ...
        lblLine.center = CGPointMake(self.view.frame.size.width/2, lblLine.center.y);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = [jobtableView dequeueReusableCellWithIdentifier:MyCellIdentifier];
