...
-(IBAction)advanceSearchDetails:(id)sender{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"BOARD_ADVANCE_SEARCH" object:nil userInfo:dic1];
    [self dissmisspop];
...
-(void)privateView:(UIViewController*)Vc
{
   ...
   // search.placeholder=@"Search Name...";
    ...
    [search_lbl addTarget:self action:@selector(searchFriends:) forControlEvents:UIControlEventEditingChanged];
    ////////////
    [main_view_private addSubview:search];
    
    UIButton *Search_btn=[[UIButton alloc]initWithFrame:CGRectMake(search.frame.size.width+search.frame.origin.x+5,bar_frnd.frame.size.height+bar_frnd.frame.origin.y+2,25,25)];
...
-(void)IndustrySearch:(UIViewController*)Vc:(int)indusId:(int)limit1
{
    ...
    Search=[[UIButton alloc]initWithFrame:CGRectMake(35, Select_Sub_Industry.frame.size.height+Select_Sub_Industry.frame.origin.y+20, 30, 30)];
...
//            }
            ...
            UIImageView *video=[[UIImageView alloc] initWithFrame:CGRectMake(cell_View.frame.size.width-74, (comment.frame.size.height+comment.frame.origin.y) - 5, 30, 30)];
            [video setImage:[UIImage imageNamed:@"video.png"]];
            [cell_View addSubview:video];
            
            UIImageView *doc=[[UIImageView alloc] initWithFrame:CGRectMake(cell_View.frame.size.width-100, comment.frame.size.height+comment.frame.origin.y, 20, 20)];
