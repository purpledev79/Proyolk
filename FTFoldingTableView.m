...
-(UIColor *)backgroundColorForSection:(NSInteger )section
{
    ...
    return [UIColor colorWithRed:228.0/255.f green:228.0/255.f blue:228.0/255.f alpha:1.f];
}
...
-(UIView *)tableView:(FTFoldingTableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    FTFoldingSectionHeader *sectionHeaderView = [[FTFoldingSectionHeader alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, [self tableView:self heightForHeaderInSection:section])
                                                                                      withTag:section];
    sectionHeaderView.strFl = tableView.strFlag;
    [sectionHeaderView setupWithBackgroundColor:[self backgroundColorForSection:section]
                              ...
                              descriptionString:[self descriptionForSection:section]
                               descriptionColor:[UIColor colorWithRed:117.0/255 green:128.0/255 blue:0.0/255 alpha:1.0]
                   ...
                   sectionState:(FTFoldingSectionState)sectionState
{
    ...
    self.arrowImageView.frame = CGRectMake(self.arrowImageView.frame.origin.x-10, self.arrowImageView.frame.origin.y,self.arrowImageView.frame.size.width, self.arrowImageView.frame.size.height);
...
-(void)shouldExpand:(BOOL)shouldExpand
{
    ...
    [UIView animateWithDuration:0.2
                     animations:^{
                         if (shouldExpand) {
                             if ([self.strFl isEqualToString:@"101"]) {
                                 self.backgroundColor =    [UIColor colorWithRed:130.0/255 green:199.0/255 blue:247.0/255 alpha:1.0f];
                             ...
                             if ([self.strFl isEqualToString:@"101"]) {
                                 self.backgroundColor =    [UIColor colorWithRed:228.0/255.f green:228.0/255.f blue:228.0/255.f alpha:1.f];
